...
const PreviewImage = ({ feature, isVisible, labelledById }) => (
  ...
  >
    <img
      ...
      src={feature.image}
      alt={`Honeywell EMS ${feature.title} screenshot`}
      loading="lazy"
      draggable="false"
    />
  </div>
      ...
      <div className="product-showcase-shell">
        <div className="landing-section-heading product-showcase-heading landing-fade-up" style={{ "--reveal-delay": "80ms" }}>
          ...
          <h2 className="landing-heading-title landing-section-title">
            See Honeywell EMS in Action
          </h2>
          <p className="landing-section-description product-showcase-description">
            Explore the modern Honeywell EMS interface for employee management, attendance,
            payroll, leave management, and employee profiles, all from one intelligent platform.
          </p>
        </div>
        ...
        <div className="product-showcase-container">
          <div
            ...
            role="tablist"
            aria-label="Honeywell EMS product showcase features"
