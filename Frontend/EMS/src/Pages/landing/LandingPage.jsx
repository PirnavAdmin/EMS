...
const NOTIFICATIONS = [
  ...
  {
    title: "Timesheet export is ready",
    meta: "Finance team",
    icon: FaFileAlt,
  },
];
...
const STAT_CARDS = [
  {
    ...
    detail:
      "Salaries, payslips, tax deductions, reimbursements, and payroll processing completed accurately and securely through Honeywell EMS.",
    icon: FaMoneyBillWave,
  },
  {
    value: 10,
    ...
    label: "Active Users",
    detail:
      "HR managers, administrators, and employees actively using the platform every day.",
    icon: FaUserCheck,
  },
  {
    value: 99.9,
    suffix: "%",
    label: "Uptime",
    detail: "built for dependable day-to-day use.",
    icon: FaGlobe,
  },
  {
    value: 24,
    suffix: "/7",
    label: "Support",
    detail: "with responsive expert help when needed.",
    icon: FaPhoneAlt,
  },
];
...
const PRICING_PLANS = [
  ...
  },
  {
    ...
    href: "mailto:sales@honeywellitsolutions.com?subject=Honeywell%20EMS%20Enterprise%20Inquiry",
    icon: FaBuilding,
  },
];
    ...
    >
      <div className="landing-hero-copy">
        ...
        <p className="landing-hero-description">
          Honeywell EMS helps businesses manage employees, attendance, payroll, leave
          management, recruitment, onboarding, performance, documents, and analytics
  ...
  <section className="landing-section" id="features">
    <div className="landing-shell">
      <SectionHeading
        ...
        description="From employee records and approvals to analytics and payroll, Honeywell EMS brings your core people operations into one streamlined workspace."
      />
...
const WhyChooseSection = () => (
  <section className="landing-section landing-section--alt" id="why-choose">
    <div className="landing-shell">
      <SectionHeading
        eyebrow="Why Choose Honeywell EMS"
        title="Built for Teams That Want Simplicity and Scale"
  ...
  <section className="landing-section" id="statistics">
    <div className="landing-shell">
      <SectionHeading
        ...
        description="The numbers below reflect how Honeywell EMS helps teams keep operations organized, visible, and dependable."
        size="stats"
      />
    ...
    <div className="landing-shell">
      <div className="landing-footer-grid landing-fade-up" style={{ "--reveal-delay": "100ms" }}>
        <div className="landing-footer-brand landing-fade-up" style={{ "--reveal-delay": "80ms" }}>
          ...
          <div className="landing-footer-brand-copy">
            <h3 className="landing-footer-brand-name">Honeywell EMS</h3>

            <p className="landing-footer-brand-tagline">Intelligent people operations.</p>
          </div>

          <p className="landing-footer-copy">
            Complete HRMS platform for modern businesses.
          </p>
        ...
        <div className="landing-footer-links-group landing-fade-up" style={{ "--reveal-delay": "260ms" }}>
          ...
          <div className="landing-footer-contact">
            <a className="landing-footer-contact-link" href="mailto:sales@honeywellitsolutions.com">
              <FaEnvelope aria-hidden="true" />
              <span>sales@honeywellitsolutions.com</span>
            </a>
            <a
              className="landing-footer-contact-link"
              href="mailto:support@honeywellitsolutions.com"
            >
              <FaEnvelope aria-hidden="true" />
              <span>support@honeywellitsolutions.com</span>
            </a>
      ...
      <div className="landing-footer-bottom landing-fade-up" style={{ "--reveal-delay": "300ms" }}>
        <p className="landing-footer-bottom-copy">
          {"\u00A9"} 2026 Honeywell IT Solutions. All rights reserved.
        </p>
