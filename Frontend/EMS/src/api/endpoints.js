...
export const API = {
    ...
    SUPER_ADMIN: {
        ...
        ORGANIZATIONS: {
            ...
            ASSIGNABLE_ADMINS: (organizationId) => `/SuperAdmin/organizations/${organizationId}/assignable-admins`,
    ...
    AGREEMENTS: {
        ...
        // Privacy Policy preview - no parameters
...
export const API_ENDPOINTS = {
    ...
    organizations: {
        ...
        assignableAdmins: API.SUPER_ADMIN.ORGANIZATIONS.ASSIGNABLE_ADMINS,
    ...
    agreements: {
        ...
        preview: API.AGREEMENTS.PREVIEW,
